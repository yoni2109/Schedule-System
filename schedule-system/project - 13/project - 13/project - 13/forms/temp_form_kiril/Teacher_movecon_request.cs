...
{
    public partial class Teacher_movecon_request : Form
    {
        ...
        {
            String Subject = "Request to move a constraint ";
            return Subject;
        }
        ...
        private void Title_Lable_Click_1(object sender, EventArgs e)
        {
