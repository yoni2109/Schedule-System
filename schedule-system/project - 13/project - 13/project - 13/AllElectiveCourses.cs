...
{
    public partial class AllElectiveCourses : Form
    {
        DataTable dt;
        String connectionString;
        public AllElectiveCourses(String connectionString)
        {
            dt = new DataTable();
        ...
        private void AllElectiveCourses_Load(object sender, EventArgs e)
        {
        ...
        private void AllElectiveCourses_FormClosed(object sender, FormClosedEventArgs e)
        {
            this.Close();
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (year != "All Years")
            {
                CompulsoryCourses = Queries.selectCoursesAccordingType(this.connectionString, 0, year);
            }
            else
                CompulsoryCourses = Queries.selectCoursesAccordingType(this.connectionString, 0);
